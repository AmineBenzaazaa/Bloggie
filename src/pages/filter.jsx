    ...
    <div class="flex justify-center">
      <div class="w-full md:w-3/4 p-2 rounded-lg">
        ...
        <div class="relative ">
          ...
          class="px-8 py-3 w-full rounded-md bg-gray-100 border-black focus:border-gray-500
        ...
        <div class="flex-none">
          <div class="relative py-8">
            <button class="bg-black text-white rounded-md py-2 px-6 absolute bottom-0 right-0 mb-4 ">
              Submit
            </button>
          </div>
        </div>
